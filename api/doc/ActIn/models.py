...
class ActIn(Base):
    ...
    contractor = relationship("Contractor", backref="acts_in_contractors")
    contract = relationship("Contract", backref="acts_in_contracts")
    organization = relationship("Organization", backref="acts_in_organizations")
