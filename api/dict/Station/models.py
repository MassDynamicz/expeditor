...
class Station(Base):
    ...
    dislocation_station_otpr = relationship("Dislocation", back_populates="station_otpr",
                                            foreign_keys='Dislocation.station_otpr_id')
    dislocation_station_tek = relationship("Dislocation", back_populates="station_tek",
                                           foreign_keys='Dislocation.station_tek_id')
    dislocation_station_nazn = relationship("Dislocation", back_populates="station_nazn",
